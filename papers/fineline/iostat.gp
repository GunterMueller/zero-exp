...
set key outside top center horizontal maxrows 2 samplen 2
...
interval=60
plot file using (column(0)/interval):1 with lines ls 1 t "Arch W", \
    "" using (column(0)/interval):2 with lines ls 2 t "Arch R", \
    "" using (column(0)/interval):3 with lines ls 3 t "Log W", \
    "" using (column(0)/interval):4 with lines ls 4 t "Log R"
    # "" using (column(0)/interval):5 with lines ls 5 t "DB W", \
    # "" using (column(0)/interval):6 with lines ls 6 t "DB R"

# iostat is in 5-sec intervals
# plot file using (column(0)/12):1 with lines ls 1 t "Log W", \
#     "" using (column(0)/12):2 with lines ls 2 t "Log R", \
#     "" using (column(0)/12):5 with lines ls 3 t "DB W", \
#     "" using (column(0)/12):6 with lines ls 4 t "DB R"
